    ...
    <>
      <div className=' w-full overflow-x-clip bg-gradient-to-r from-orange-100 to-blue-100 mt-[4rem] pb-5'>
        ...
        <motion.div 
          ...
          <h1 className='text-lg font-semibold bg-gradient-to-r from-gray-400 via-red-700 to-teal-400 bg-clip-text text-transparent'>পরিচালনায়:</h1>
          <h1 className='text-2xl py-1 md:text-3xl font-bold bg-gradient-to-r from-orange-700 to-red-600 bg-clip-text text-transparent'>বাঁকাদহ সর্বজনীন দুর্গোৎসব</h1>
